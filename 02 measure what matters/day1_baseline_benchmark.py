...
PROMPTS = [
    ...
    "Explain what each part does in the following command: `vllm serve Qwen/Qwen2.5-3B-Instruct-AWQ --quantization awq_marlin --max-model-len 2048 --gpu-memory-utilization 0.90 --dtype float16`",
    ...
    "What does concurrency mean in the context of LLM serving?",
