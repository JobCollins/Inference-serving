...
| `04 kv cache paging/` | KV sizing, PagedAttention, prefix-cache experiment — see folder README |
| `05 quantization/` | 4-bit AWQ + FP16 before/after (Days 5–6) — see folder README |
